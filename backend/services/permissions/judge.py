...
only the shell runner can keep: it adopts the directory a command left the
shell in **only while that is still under the root**
(``services/sandbox/shell_runner.py``). Let
