...
llm, embeddings, vectorstore, search, memory, tts, stt, mail,
dav. Each presents a clean async interface and could run in-process or behind
HTTP. Reused by tools (the agent calls them) and by plain routes (the user calls
directly) — logic never hides in a tool.
